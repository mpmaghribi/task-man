...
<body>
                        ...
                        <section class="panel">
                            <header class="panel-heading tab-bg-dark-navy-blue ">
                                ...
                                <div class="btn-group btn-group-lg btn-xs" style="float: right; margin-top: -35px;padding-top: 0px; font-size: 12px;" id="div_acc_edit_cancel_usulan_pekerjaan">
                                    <a class="btn btn-success btn-xs" href="javascript:dialog_setujui_usulan()" id="tombol_accept_usulan" style="font-size: 10px">Setujui</a>
                                    <a class="btn btn-danger btn-xs" href="<?php echo site_url(); ?>/pekerjaan_staff/view_edit_usulan?id_pekerjaan=<?php echo $pekerjaan['id_pekerjaan']; ?>" id="tombol_edit_usulan" style="font-size: 10px">Edit</a>
    ...
    <script>
		...
		var list_akun =<?= json_encode($list_user) ?>;
		...
		function hapus_usulan(){	
                    window.location = site_url + "/pekerjaan_staff/hapus_usulan_page?id_pekerjaan=" + pekerjaan["id_pekerjaan"];
		}
                
                function dialog_setujui_usulan(){
                    $("#modal_any").modal("show");
                    $("#modal_any_title").html("Konfirmasi Setujui Usulan");
                    $("#modal_any_body").html('<h5>Anda akan menyetujui usulan pekerjaan <strong>'+pekerjaan['nama_pekerjaan']+'</strong>. Lanjutkan?</h5>');
                    $("#modal_any_button_cancel").attr({'class': 'btn btn-info'}).html("Batal");
                    $("#modal_any_button_ok").attr({onclick: 'setujui_usulan()', 'class': 'btn btn-success'}).html("Setujui Usulan");
                }
                
                function setujui_usulan(){
                    window.location = site_url + "/pekerjaan_staff/setujui_usulan_page?id_pekerjaan=" + pekerjaan["id_pekerjaan"];
                }
...
//			if (c == true) {
				$.ajax({// create an AJAX call...
					...
					url: "<?php echo site_url(); ?>/pekerjaan_staff/hapus_file_json", // the file to call
