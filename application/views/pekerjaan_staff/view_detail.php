                                        ...
                                        <div class="col-md-12">
                                            <section class="panel">
                                                <h4 style="color: #1FB5AD;">
                                                    <?php if ($pekerjaan['flag_usulan']== '2') { ?>
                                                        Pembuat Pekerjaan
                                                    <?php } else if ($pekerjaan['flag_usulan'] == '1' || $pekerjaan['flag_usulan'] == '9') { ?>
                                                        Ditujukan Kepada
                                                    <?php } ?>
                                                </h4>
                                                <p style="font-size: larger" id="nama_penanggung_jawab">
                                                    <?= isset($users[$pekerjaan['id_penanggung_jawab']])? $users[$pekerjaan['id_penanggung_jawab']]->nama : 'kesalahan'; ?>
                                                </p>
                                                <h4 style="color: #1FB5AD;">
                                                    Nama Pekerjaan
                                                </h4>
